...
- git reset --soft <commit> — переместить текущую ветку на <commit>, не задавать индекс и директорию, оставить изменения в индексе и директории
...
- git difftool <from_commit> [<to_commit>] — разница через difftool